    ...
    function futweb() {
        ...
        events.isEligibleForOneFill = (obj) => {
            ...
            if (_.size(obj) !== 2 || !_.every(obj, o =>
                _.isEqual(_.sortBy(_.keys(o)), _.intersection(_.keys(o), allowedKeys).sort()))) {
                return false;
            }
